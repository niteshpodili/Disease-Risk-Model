...
| **Blood Pressure** | Integer ($80–220\text{ mmHg}$) | Systolic hemodynamic parameter |
| **Cholesterol** | Integer ($100–400\text{ mg/dL}$) | Serum lipid biomarker |
| **Heart Rate** | Integer ($40–180\text{ bpm}$) | Resting cardiovascular rate |
...
* **Hosting & Backend as a Service**: InsForge (`https://insforge.dev`) & Supabase (`https://supabase.com`).
