...
## Live Deployments and Access Links

* **Production Web Application (InsForge)**: [https://h3ddgmpu.insforge.site](https://h3ddgmpu.insforge.site)
* **InsForge Project Dashboard**: [https://insforge.dev/dashboard/project/0f26a274-f17d-4e6f-8c56-591708e359f8](https://insforge.dev/dashboard/project/0f26a274-f17d-4e6f-8c56-591708e359f8)
* **InsForge Backend API Base**: `https://h3ddgmpu.us-east.insforge.app`
* **GitHub Repository**: [https://github.com/niteshpodili/Disease-Risk-Model](https://github.com/niteshpodili/Disease-Risk-Model)
...
* **Cloud and Database**: InsForge (BaaS and Web Hosting), Supabase PostgreSQL.
...
```
Backend API will be live at `http://127.0.0.1:8000` (Swagger documentation at `/docs`).
...
* [User Guide and Demo Playbook](Docs/USER_GUIDE.md)
* [Privacy Policy (Zero-PII Compliance)](Docs/PRIVACY_POLICY.md)
