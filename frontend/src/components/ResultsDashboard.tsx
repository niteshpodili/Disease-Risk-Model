...
export const ResultsDashboard: React.FC<ResultsDashboardProps> = ({
  ...
  const theme = isHigh
    ? {
        color: 'text-[#DC2626]',
        badgeBg: 'bg-gradient-to-br from-[#F87171] to-[#DC2626] text-white',
        stroke: '#DC2626',
    ...
    ? {
        color: 'text-[#D97706]',
        badgeBg: 'bg-gradient-to-br from-[#FBBF24] to-[#D97706] text-white',
        stroke: '#D97706',
        icon: <AlertCircle className="w-5 h-5 text-white" />
      }
    : {
        color: 'text-[#059669]',
        badgeBg: 'bg-gradient-to-br from-[#34D399] to-[#059669] text-white',
        stroke: '#059669',
  ...
  useEffect(() => {
    if (result.id !== runId.current) {
      ...
      const raf = requestAnimationFrame(() => {
        setAnimatedOffset(circumference - (risk_percentage / 100) * circumference);
      });
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span
                style={{ fontFamily: 'Nunito, sans-serif' }}
                className="text-[11px] font-extrabold uppercase px-2.5 py-0.5 rounded-full bg-[#E0F2FE] text-[#0284C7] border border-[#BAE6FD]"
              >
                Primary Engine
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        ...
        <div className="flex flex-col items-center justify-center p-8 bg-white/90 border border-white rounded-[32px] shadow-clay-card relative">
          <div className="relative w-44 h-44 flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center">
              <span
                style={{ fontFamily: 'Nunito, sans-serif' }}
                className={`text-4xl font-black ${theme.color} tracking-tight`}
              >
          ...
          <span
            style={{ fontFamily: 'Nunito, sans-serif' }}
            className="text-xs font-bold text-[#635F69] text-center mt-3"
          >
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div className="bg-white/90 border border-white rounded-[28px] p-6 shadow-clay-card space-y-2">
            <span
              style={{ fontFamily: 'Nunito, sans-serif' }}
              className="text-xs font-extrabold text-[#635F69] flex items-center gap-2 uppercase tracking-wider"
            >
            ...
            <div
              style={{ fontFamily: 'Nunito, sans-serif' }}
              className={`text-xl font-black ${theme.color}`}
            >
          ...
          <div className="sm:col-span-2 bg-[#F4F1FA] border border-[#E9E4F2] rounded-[28px] p-5 shadow-clay-pressed">
            <span
              style={{ fontFamily: 'Nunito, sans-serif' }}
              className="text-xs font-extrabold text-[#635F69] uppercase tracking-wider block mb-3"
            >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
              <div className="p-3 rounded-[20px] bg-white border border-[#E9E4F2] shadow-clay-orb">
                ...
                <span
                  style={{ fontFamily: 'Nunito, sans-serif' }}
                  className="text-[#332F3A] font-black text-sm"
                >
                  {input.age} yrs
                </span>
              </div>
